...
body = 'B 155.0.0.0/8 10\r\n'
updateHelper(body)

queryHelper('155.33.5.45','B', 10)
queryHelper('155.35.2.45','B', 10)
queryHelper('155.37.1.45','B', 10)
queryHelper('154.255.255.254','A', 100)
queryHelper('156.0.0.1','A', 100)

# update with some routes that should be ignored
body = 'C 155.33.0.0/16 30\r\n'
body += 'C 155.35.0.0/16 30\r\n'
body += 'C 155.37.0.0/16 30\r\n'
updateHelper(body)
