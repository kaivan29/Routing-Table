...
# update with some nested tests for B, C, D
body = 'B 155.33.0.0/16 20\r\n'
body += 'C 155.33.1.0/24 5\r\n'
body += 'D 155.0.0.0/8 30\r\n'
updateHelper(body)

# query, even with new routes should give A at weight 100
queryHelper('192.168.2.100','A', 100)

queryHelper('155.33.5.5','B', 20)
queryHelper('155.33.1.5','C', 5)
queryHelper('155.11.5.5','D', 30)

# update with some more nested routes, including some both in B at different costs
body = 'B 155.0.1.0/24 20\r\n'
body += 'B 155.33.5.0/24 5\r\n'
updateHelper(body)

queryHelper('155.33.5.5','B', 5)
queryHelper('155.33.2.5','B', 20)
queryHelper('155.33.1.5','C', 5)
queryHelper('155.0.1.5','B', 20)
queryHelper('155.1.1.5','D', 30)

# check some basic things are still right
queryHelper('154.255.255.200','A', 100)
queryHelper('156.0.0.1','A', 100)

# put a lower cost one OVER an older higher cost
body += 'E 155.33.1.0/24 2\r\n'
updateHelper(body)

# Check it
queryHelper('155.33.1.5','E', 2)
